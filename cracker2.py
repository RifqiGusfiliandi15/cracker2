...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mLoanjing \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN MAke AKUN FACEBOOK SIA GOBLOG  \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.instagram.com/rifqq.id/')
                time.sleep(2)
                menu()
